...
data_rub = loadtxt(path + r"\\rub\\phd_exp_contrast_rub_table.txt")
data_hyd = loadtxt(path + r"\\hyd\\phd_exp_contrast_hyd_table.txt")
data_mar = loadtxt(path + r"\\mar\\phd_exp_contrast_mar_table.txt")
...
ax1.set_xlabel('contrast level, \%', size=label_font_size)
...
y_lables = ['{:.1f}'.format(x) for x in arange(0, 0.81, 0.1)]
y_lables[0] = ''
ax1.set_yticks(arange(0, 0.81, 0.1))
ax1.set_yticklabels(y_lables)

ax1.set_xticklabels([r'100', '50', '25', '16', '12.5', '7.5'])
...
ax3.set_xlabel(r'contrast level, \%', size=label_font_size)
...
y_lables = ['{:.1f}'.format(x) for x in arange(0, 0.81, 0.1)]
y_lables[0] = ''
ax3.set_yticks(arange(0, 0.81, 0.1))
ax3.set_yticklabels(y_lables)

ax3.set_xticklabels([r'100', '50', '25', '16', '12.5', '7.5'])
...
ax5.set_xlabel(r'contrast level, \%', size=label_font_size)
ax5.set_ylabel('average endpoint error, pixels', size=label_font_size)
ax5.set_title('$\mathit{New Marble}$', size=title_font_size)
ax5.yaxis.set_label_coords(-0.124, 0.5) # Fix spacing between label and axis

y_lables = ['{:.2f}'.format(x) for x in arange(0, 0.405, 0.05)]
y_lables[0] = ''
ax5.set_yticks(arange(0, 0.405, 0.05))
ax5.set_yticklabels(y_lables)

ax5.set_xticklabels([r'100', '50', '25', '16', '12.5', '7.5'])
