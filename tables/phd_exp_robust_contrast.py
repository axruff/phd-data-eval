...
data_all = np.load(data_path + r"robust_contrast\\rub2\\numpy_data.npy")


with open(data_path + r"robust_contrast\\rub2\\numpy_data.txt", 'r') as f:
...
print "100", "\t", "grey robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "100", "\t", "grad robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "50", "\t", "grey robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "50", "\t", "grad robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "25", "\t", "grey robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "25", "\t", "grad robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "12", "\t", "grey robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
...
print "12", "\t", "grad robust", "\t", np.min(data_all[sigma, data, 1, :,aee_all]), "\t", np.min(data_all[sigma, data, 1, :,aee_disc]), "\t", np.min(data_all[sigma, data, 1, :,aee_untext])
